...
class Register extends React.Component {
  ...
  onSubmitSignIn = () => {
    fetch('https://guarded-chamber-36984.herokuapp.com/register', {
      method: 'post',
...
<main className="pa4 white-80">
  <div className="measure">
    ...
    <div className="">
      <input onClick={this.onSubmitSignIn} className="b ph3 pv2 input-reset ba b--white white bg-transparent grow pointer f6 dib" type="submit" value="Register" />
    </div>  
  </div>
</main>
</article>
